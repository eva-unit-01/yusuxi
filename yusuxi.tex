...
\geometry{a5paper,centering,scale=0.8} %定义页面使用 A6 纸大小，版心居中，长宽占页面的 0:8 倍
% \hypersetup{
%     bookmarks = false,
%     % colorlinks = true,
% }
...
\newfontfamily\sys{Source Han Serif CN}
\def\kaomojihide{{\sys | ω ·´)}}%原本的kaomoji是| ω・´)，ctex无法显示・,将其改为了中文间隔号·
%------------------------
